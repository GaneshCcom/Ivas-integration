	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>electricals/">Electricals</a></li>
		    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>electricals/fans/">Fans</a></li>
						  ...
						  <div class="card card-body">
						  	<?php if( count($cateLists) > 0 ) {
								...
								$i++;
											if($cate->cat_id == "11")
											{	
												$catslug = "midnight-collection";
											}elseif ($cate->cat_id == "12") {
												$catslug = "water-closets";
											}elseif ($cate->cat_id == "13") {
												$catslug = "wash-basins";
											}else{
												$catslug = "#";
											} 
							...
							<div class="form-check">			
							  <a href="<?php echo base_url(); ?>sanitaryware/<?php echo $catslug; ?>/"><input class="form-check-input" type="checkbox" value="<?php echo $cate->cat_id; ?>" name="<?php echo $catslug; ?>" id="cat-<?php echo $catslug; ?>" <?php if($cate->cat_id == "11"){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $catslug; ?>")'>
