	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Sanitary Ware</li>
		  </ol>
		</nav>
	</div>
</div>	
	...
	<div class="container">
		...
		<div class="row catdiv">
			<?php if( count($cateLists) > 0 ) {
				...
				$i++;
							if($cate->cat_name == "Wash Basins")
							{	
								$caticon = "fan-icon.png";
								$catslug = "wash-basins";
							}elseif ($cate->cat_name == "Water Closets") {
								$caticon = "led-icon.png";
								$catslug = "water-closets";
							}elseif ($cate->cat_name == "Midnight Collection") {
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="catblock">
					<div class="catimg">
						<a href="<?php echo base_url(); ?>sanitaryware/<?php echo $catslug; ?>/"><img src="<?php echo base_url(); ?>assets/category-list-img/<?php echo $cate->cat_list_img; ?>" alt="<?php echo $cate->cat_name; ?>"></a>
					</div>
					<div class="catcnt">
						...
						<ul>
							<?php foreach ($cate->subs as $sub)  { ?>
								<li><a href="<?php echo base_url(); ?>sanitaryware/<?php echo $catslug; ?>/category/<?php echo $sub->sub_cat_slug; ?>/"><?php echo $sub->sub_cat_name; ?></a></li>
							<?php } ?>	
						</ul>
						<?php } ?>	
						<p class="catlink"><a href="<?php echo base_url(); ?>sanitaryware/<?php echo $catslug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
					</div>
				</div>
			</div>
			<?php endforeach; } ?>
