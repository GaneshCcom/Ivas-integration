	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item active" aria-current="page">Quartz</li>
		  </ol>
		</nav>
	</div>
</div>	
<div class="homecategorysec">
	<div class="container">
		...
		<div class="row catdiv">
			<?php if( count($parentCateLists) > 0 ) {
				$i = 0; 
				foreach($parentCateLists as $key => $parCate): 
				$i++;
							if($parCate->par_cat_name == "Quartz")
							{	
								$caticon = "fan-icon.png";
								$catslug = "quartz";
							}elseif ($parCate->par_cat_name == "Electricals") {
								$caticon = "led-icon.png";
								$catslug = "electricals";
							}elseif ($parCate->par_cat_name == "Appliances") {
								$caticon = "water-heater-icon.png";
								$catslug = "appliances";
							}elseif ($parCate->par_cat_name == "Tiles") {
								$caticon = "water-heater-icon.png";
								$catslug = "tiles";
							}elseif ($parCate->par_cat_name == "Designer Hardware") {
								$caticon = "water-heater-icon.png";
								$catslug = "design-hardware";
							}elseif ($parCate->par_cat_name == "Sanitaryware") {
								$caticon = "water-heater-icon.png";
								$catslug = "sanitaryware";
							}elseif ($parCate->par_cat_name == "Bath Fittings") {
								$caticon = "water-heater-icon.png";
								$catslug = "bath-fittings";
							}elseif ($parCate->par_cat_name == "Modular Kitchen") {
								$caticon = "water-heater-icon.png";
								$catslug = "modularkitchen";
							}
							else{
								$caticon = "fan-icon.png";
								$catslug = "#";
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="catblock">
					<div class="catimg">
						<a href="<?php echo base_url(); ?><?php echo $catslug; ?>/"><img src="<?php echo base_url(); ?>assets/category-list-img/<?php echo $parCate->par_cat_list_img; ?>" alt="<?php echo $parCate->par_cat_name; ?>"></a>
					</div>
					<div class="catcnt">
						<div class="cattitlblk">
							<h3 class="title"><?php echo $parCate->par_cat_name; ?></h3>
							<img src="<?php echo base_url(); ?>res/images/<?php echo $caticon; ?>" alt="<?php echo $parCate->par_cat_name; ?>">
						</div>
						<p><?php echo $parCate->par_cat_desc; ?></p>
						<?php 
						//made changes here to ignore quartz sub category
						 if($parCate->par_cat_name !== "Quartz" && $parCate->par_cat_name !== "Modular Kitchen" && !empty($parCate->subs)) { 
						?>
						<ul>
							<?php foreach ($parCate->subs as $sub)  { ?>
								<li><a href="<?php echo base_url(); ?><?php echo $catslug; ?>/<?php echo $sub->cat_slug; ?>/"><?php echo $sub->cat_name; ?></a></li>
							<?php } ?>	
						</ul>
						<?php } ?>	
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-12">
							<div class="fancatblk fanblk1">
								<a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_esnInfo->sub_cat_slug; ?>"><img src="<?php //echo base_url(); ?>assets/sub-category-list-img/<?php //echo $subcat_esnInfo->sub_cat_list_img; ?>" alt="<?php //echo $subcat_esnInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php //echo $subcat_esnInfo->sub_cat_name; ?></h2>
									<p><?php //echo $subcat_esnInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php //echo base_url(); ?>category/<?php// echo $subcat_esnInfo->sub_cat_slug; ?>">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-12">
							<div class="fancatblk fanblk2">
								<a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_carInfo->sub_cat_slug; ?>"><img src="<?php// echo base_url(); ?>assets/sub-category-list-img/<?php //echo $subcat_carInfo->sub_cat_list_img; ?>" alt="<?php //echo $subcat_carInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php// echo $subcat_carInfo->sub_cat_name; ?></h2>
									<p><?php //echo $subcat_carInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_carInfo->sub_cat_slug; ?>">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>	
					</div>	
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_calInfo->sub_cat_slug; ?>"><img src="<?php //echo base_url(); ?>assets/sub-category-list-img/<?php// echo $subcat_calInfo->sub_cat_list_img; ?>" alt="<?php //echo $subcat_calInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php //echo $subcat_calInfo->sub_cat_name; ?></h2>
									<p><?php //echo $subcat_calInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_calInfo->sub_cat_slug; ?>">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php// echo base_url(); ?>category/<?php //echo $subcat_mulInfo->sub_cat_slug; ?>"><img src="<?php //echo base_url(); ?>assets/sub-category-list-img/<?php //echo $subcat_mulInfo->sub_cat_list_img; ?>" alt="<?php //echo $subcat_mulInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php //echo $subcat_mulInfo->sub_cat_name; ?></h2>
									<p><?php //echo $subcat_mulInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php// echo base_url(); ?>category/<?php ///echo $subcat_mulInfo->sub_cat_slug; ?>">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_solInfo->sub_cat_slug; ?>"><img src="<?php //echo base_url(); ?>assets/sub-category-list-img/<?php //echo $subcat_solInfo->sub_cat_list_img; ?>" alt="<?php //echo $subcat_solInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php //echo $subcat_solInfo->sub_cat_name; ?></h2>
									<p><?php //echo $subcat_solInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php //echo base_url(); ?>category/<?php //echo $subcat_solInfo->sub_cat_slug; ?>">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>	
					</div>	
