		...
		<div class="row align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/accessories-and-mirrors/category/<?php echo $subcat_dry_ironInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/accessories-and-mirrors/category/<?php echo $subcat_steam_ironInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
