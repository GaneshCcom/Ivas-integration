						  ...
						  <div class="card card-body">
						    <?php if( count($cateLists) > 0 ) {
								...
								$i++;
											...
											{	
												$catslug = "faucets";
											}elseif ($cate->cat_id == "18") {
												$catslug = "showers";
											}elseif ($cate->cat_id == "19") {
												$catslug = "accessories-and-mirrors";
											}else{
												$catslug = "#";
											}
							?>
							<div class="form-check">			
							  <a href="<?php echo base_url(); ?>bath-fittings/<?php echo $catslug; ?>"><input class="form-check-input" type="checkbox" value="<?php echo $cate->cat_id; ?>" name="<?php echo $catslug; ?>" id="cat-<?php echo $catslug; ?>" <?php if($cate->cat_id == "18"){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $catslug; ?>")'>
						...
						<div class="accordion accordion-flush" id="accordionFaq">
							  ...
							  <?php if( count($faqLists) > 0 ) {
									...
									foreach($faqLists as $key => $faq): 
										...
										if ($faq->cat_name == "Kitchen Appliances") {
											if ($faq->sub_cat_name == "Chimney") {
												$faqclass = "chimney"; // Specific class for Kitchen Appliances - Chimney
											} elseif ($faq->sub_cat_name == "Hob") {
												$faqclass = "hob"; // Specific class for Kitchen Appliances - Hob
											} else {
												$faqclass = "kitchen"; // Default class for Kitchen Appliances
											}
										} elseif ($faq->cat_name == "Cooking Appliances") {
											$faqclass = "cooking"; // Class for Cooking Appliances
