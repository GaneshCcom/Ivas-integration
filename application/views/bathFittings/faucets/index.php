		...
		<div class="row align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/faucets/category/<?php echo $subcat_mixer_grinderInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/faucets/category/<?php echo $subcat_chopperInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
		...
		<div class="row align-items-center">
			...
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/faucets/category/<?php echo $subcat_hand_blenderInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/faucets/category/<?php echo $subcat_electric_kettleInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>	
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatimg">
		...
		<div class="row align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/faucets/category/<?php echo $subcat_sandwich_makerInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>bath-fittings/faucets/category/<?php echo $subcat_rice_cookerInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
