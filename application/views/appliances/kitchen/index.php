		...
		<div class="row align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>appliances/kitchen/category/<?php echo $subcat_chimneyInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>appliances/kitchen/category/<?php echo $subcat_hobInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
		...
		<div class="row align-items-center">
			...
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					...
					<p class="link"><a href="<?php echo base_url(); ?>appliances/kitchen/category/<?php echo $subcat_cooktopInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					...
					<p class="link"><a href="<?php echo base_url(); ?>appliances/kitchen/category/<?php echo $subcat_inductionInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>	
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatimg">
