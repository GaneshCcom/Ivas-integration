						  ...
						  <div class="card card-body">
						    <?php if( count($cateLists) > 0 ) {
								...
								$i++;
											...
											{	
												$catslug = "cooking";
											}elseif ($cate->cat_id == "7") {
												$catslug = "kitchen";
											}elseif ($cate->cat_id == "6") {
												$catslug = "fabric";
											}else{
												$catslug = "#";
											}
							...
							<div class="form-check">			
							  <a href="<?php echo base_url(); ?>appliances/<?php echo $catslug; ?>"><input class="form-check-input" type="checkbox" value="<?php echo $cate->cat_id; ?>" name="<?php echo $catslug; ?>" id="cat-<?php echo $catslug; ?>" <?php if($cate->cat_id == "7"){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $catslug; ?>")'>
