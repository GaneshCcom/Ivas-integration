				...
				<div class="homecatlist">
					<?php if( count($cateLists) > 0 ) {
						...
						foreach($cateLists as $key => $cate): 
									if($cate->cat_name == "Cooking")
									{	
										$catslug = "cooking";
									}elseif ($cate->cat_name == "Kitchen") {
										$catslug = "kitchen";
									}elseif ($cate->cat_name == "Fabric") {
										$catslug = "fabric";
									}else{
										$catslug = "#";
									}
						...
						<div class="catcntblk">
							...
							<div class="row">
								...
								<div class="col-xl-4 col-lg-4 col-md-4 col-6">
									<div class="subcatblk">
										<a href="<?php echo base_url(); ?>appliances/<?php echo $catslug; ?>/category/<?php echo $sub->sub_cat_slug; ?>">
							...
							<?php } ?>
							<hr/>
							<p class="link"><a href="<?php echo base_url(); ?>appliances/<?php echo $catslug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
						</div>
					</div>
					<div class="col-xl-6 col-lg-6 col-md-12">
						<div class="catimgblk">
