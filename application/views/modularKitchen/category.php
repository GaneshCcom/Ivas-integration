	...
	<div class="container">
	    <nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
		    ...
		    <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Quartz</a></li>
						  ...
						  <div class="card card-body">
						  	<?php if( count($cateLists) > 0 ) {
								...
								$i++;
											if($cate->cat_id == "20")
											{	
												$catslug = "modular-kitchen";
											}else{
												$catslug = "#";
											} 
							?>
							<div class="form-check">			
							  <a href="<?php echo base_url(); ?><?php echo $catslug; ?>"><input class="form-check-input" type="checkbox" value="<?php echo $cate->cat_id; ?>" name="<?php echo $catslug; ?>" id="cat-<?php echo $catslug; ?>" <?php if($cate->cat_id == "20"){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $catslug; ?>")'>
					...
					<div class="catfiltblk">
						...
						<div class="collapse show" id="filtertypes">
						  <div class="card card-body">
							...
							?>	
							<?php //print_r($subcate); //die;?>
							<div class="form-check">
							  <a href="<?php echo base_url(); ?><?php echo $modularkitchencatslug; ?>/category/<?php echo $subcate->sub_cat_slug; ?>"><input class="form-check-input" type="checkbox" value="<?php echo $subcate->sub_cat_id; ?>" name="<?php echo $subcate->sub_cat_slug; ?>" id="type-<?php echo $subcate->sub_cat_slug; ?>" <?php if($subcate->sub_cat_id == $subcateInfo->sub_cat_id){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $quartzcatslug; ?>/category/<?php echo $subcate->sub_cat_slug; ?>")'>
						...
						<div class="collapse show" id="<?php echo $filtercolaps; ?>">
						  <div class="card card-body">
						  	<?php foreach($attributevalueLists as $key => $attributevalue){ 
								// print_r($attributevalueLists); die;
							...
							<?php foreach($attributevaluecount as $key => $attributecount){
								// print_r($attributevaluecount); die;
...
<script>
    jQuery(document).ready(function() {
        ...
        jQuery.ajax({
             url : "<?php echo base_url('quartz/filterproducts') ?>",
             type: "post",
