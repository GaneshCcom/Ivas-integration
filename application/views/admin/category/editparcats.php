					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="card ">
							<div class="card-header border-0">
								<h4 class="card-title">Edit Parent Category</h4>
							 ...
							 <form class="add-dept" name="edit-parcats" method="post" action="<?php //echo $action; ?>" enctype="multipart/form-data">
								<div class="card-body" >
									<div class="row">
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<textarea class="form-control" name="par_cat_desc" id="par_cat_desc" value="<?php echo set_value('par_cat_desc', $this->form_data->par_cat_desc); ?>"><?php echo set_value('par_cat_desc', $this->form_data->par_cat_desc); ?></textarea> <br/>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<img class="mb-3" src="<?php echo base_url(); ?>assets/category-back-img/<?php echo $this->form_data->par_cat_back_img; ?>" height="70px">
												<div class="input-group file-browser">
													<input class="form-control" name="par_cat_back_img" type="file">
												</div>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<img class="mb-3" src="<?php echo base_url(); ?>assets/category-list-img/<?php echo $this->form_data->par_cat_list_img; ?>" height="70px">
												<div class="input-group file-browser">
													<input class="form-control" name="par_cat_list_img" type="file">
												</div>
												<small class="text-muted"><i>The file size should not be more than 1MB</i></small>
										...
										<div class="col-sm-12 col-md-12">
											<div class="form-group">
												...
												<?php $status = $this->form_data->par_cat_status; ?>
								...
								<div class="col-md-12 card-footer">
									<div class="form-group float-end">
										<input type="submit"  name="editparcats"  class="btn btn-primary" value="Save Changes">
									</div>
								</div>
							</form>
						</div>
