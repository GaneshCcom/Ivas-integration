            ...
            <div class="side-app">
                ...
                <div class="page-header d-xl-flex d-block">
                    <div class="page-leftheader">
                        <h4 class="page-title"><span class="font-weight-normal text-muted ms-2">Import FAQs</span></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header border-0">
                                <h4 class="card-title">Import FAQs from Excel</h4>
                            ...
                            <form method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" name="faqs_file" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 card-footer">
                                    <div class="form-group float-end">
                                        <input type="submit" class="btn btn-primary" value="Import FAQs">
                                    </div>
                                </div>
                            </form>
                        </div>
