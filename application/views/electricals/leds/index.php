					...
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="fancatblk fanblk3">
								<a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_ledbulbInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_ledbulbInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_ledbulbInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									...
									<p class="fnlink"><a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_ledbulbInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>	
					</div>	
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_cellingledInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_cellingledInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_cellingledInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_cellingledInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_cellingledInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_cellingledInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_outdoorledInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_outdoorledInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_outdoorledInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_outdoorledInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_outdoorledInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_outdoorledInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_industrialledInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_industrialledInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_industrialledInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_industrialledInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_industrialledInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>electricals/leds/category/<?php echo $subcat_industrialledInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>	
					</div>	
