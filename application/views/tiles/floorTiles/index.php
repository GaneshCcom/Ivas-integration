					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-12">
							<div class="fancatblk fanblk1">
								<a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_tpwInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_tpwInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_tpwInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_tpwInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_tpwInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_tpwInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-6 col-lg-6 col-md-12">
							<div class="fancatblk fanblk2">
								<a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_bldcInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_bldcInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_bldcInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_bldcInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_bldcInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_bldcInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>	
					</div>	
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_cellingInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_cellingInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_cellingInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_cellingInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_cellingInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_cellingInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_ventilationInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_ventilationInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_ventilationInfo->sub_cat_name; ?>/"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_ventilationInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_ventilationInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_ventilationInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="fancatblks2">
								<a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_decorativeInfo->sub_cat_slug; ?>/"><img src="<?php echo base_url(); ?>assets/sub-category-list-img/<?php echo $subcat_decorativeInfo->sub_cat_list_img; ?>" alt="<?php echo $subcat_decorativeInfo->sub_cat_name; ?>"></a>
								<div class="fancatblkcnt">
									<h2 class="title"><?php echo $subcat_decorativeInfo->sub_cat_name; ?></h2>
									<p><?php echo $subcat_decorativeInfo->sub_cat_desc; ?></p>
									<p class="fnlink"><a href="<?php echo base_url(); ?>tiles/floor-tiles/category/<?php echo $subcat_decorativeInfo->sub_cat_slug; ?>/">view more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>	
					</div>	
