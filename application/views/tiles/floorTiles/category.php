						...
						<div class="collapse show" id="filtercat">
						  <div class="card card-body">
							...
							<div class="form-check">			
							  <a href="<?php echo base_url(); ?>tiles/<?php echo $catslug; ?>/"><input class="form-check-input" type="checkbox" value="<?php echo $cate->cat_id; ?>" name="<?php echo $catslug; ?>" id="cat-<?php echo $catslug; ?>" <?php if($cate->cat_id == "14"){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $catslug; ?>")'>
