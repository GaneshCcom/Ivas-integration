						...
						<div class="collapse show" id="filtercat">
						  <div class="card card-body">
							...
							<div class="form-check">			
							  <a href="<?php echo base_url(); ?>design-hardware/<?php echo $catslug; ?>/"><input class="form-check-input" type="checkbox" value="<?php echo $cate->cat_id; ?>" name="<?php echo $catslug; ?>" id="cat-<?php echo $catslug; ?>" <?php if($cate->cat_id == "10"){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $catslug; ?>")'>
					...
					<div class="catfiltblk">
						...
						<div class="collapse show" id="filtertypes">
						  <div class="card card-body">
							...
							?>	
							<div class="form-check">
							  <a href="<?php echo base_url(); ?>design-hardware/<?php echo $furniturefittingsslug; ?>/category/<?php echo $subcate->sub_cat_slug; ?>"><input class="form-check-input" type="checkbox" value="<?php echo $subcate->sub_cat_id; ?>" name="<?php echo $subcate->sub_cat_slug; ?>" id="type-<?php echo $subcate->sub_cat_slug; ?>" <?php if($subcate->sub_cat_id == $subcateInfo->sub_cat_id){ echo "checked"; } else { echo "unchecked"; } ?> onclick='window.location.assign("<?php echo base_url(); ?><?php echo $furniturefittingsslug; ?>/category/<?php echo $subcate->sub_cat_slug; ?>")'>
