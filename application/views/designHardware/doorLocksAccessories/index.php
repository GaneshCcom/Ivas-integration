...
<div class="innerpagebannersec" style="background-image: url('<?php echo base_url(); ?>assets/category-back-img/<?php echo $cateInfo->cat_back_img; ?>');">
	...
	<div class="hminqfrm d-lg-block d-none">
		<div class="ctafrm">
			...
			<p class="privacytxt">By submitting this form, you agree to the <a href="../privacy-policy.php" target="_blank">privacy policy</a> &amp; <a href="../terms-and-conditions.php" target="_blank">terms and conditions</a></p>
		</div>
	</div>
</div>
<div class="homebreadcrumbsec">
	<div class="container">
		...
		<!-- <div class="row heading-h1">
		<center><h1>Essential Cooking Appliances for Every Kitchen</h1></center>
        </div> -->
	</div>
</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>design-hardware/door-locks-and-accessories/category/<?php echo $subcat_mixer_grinderInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>design-hardware/door-locks-and-accessories/category/<?php echo $subcat_chopperInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
		...
		<div class="row align-items-center">
			...
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					...
					<p class="link"><a href="<?php echo base_url(); ?>design-hardware/door-locks-and-accessories/category/<?php echo $subcat_hand_blenderInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatcnt maincatcntsm">
					...
					<p class="link"><a href="<?php echo base_url(); ?>design-hardware/door-locks-and-accessories/category/<?php echo $subcat_electric_kettleInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>	
			<div class="col-xl-3 col-lg-3 col-md-6">
				<div class="maincatimg">
		...
		<div class="row align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>design-hardware/door-locks-and-accessories/category/<?php echo $subcat_sandwich_makerInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg scndimg">
		...
		<div class="row align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatcnt">
					...
					<p class="link"><a href="<?php echo base_url(); ?>design-hardware/door-locks-and-accessories/category/<?php echo $subcat_rice_cookerInfo->sub_cat_slug; ?>">view All Products <i class="fa fa-angle-right"></i></a></p>
				</div>
			</div>
			<div class="col-xl-4 col-lg-4 col-md-6">
				<div class="maincatimg">
