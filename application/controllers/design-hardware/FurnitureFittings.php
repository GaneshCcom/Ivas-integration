...
class FurnitureFittings extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_mixer_grinder = 15;
		$subcat_chopper = 15;
		$subcat_hand_blender = 15;
		$subcat_electric_kettle = 15;
		$subcat_sandwich_maker = 15;
		$subcat_rice_cooker = 15;
		...
		$this->load->view('designHardware/furnitureFittings/index', $data);
	}
	...
	public function category($slug)
	{
		...
		$furniturefittingsslug = "furniture-fittings";
		$data['furniturefittingsslug'] = $furniturefittingsslug; 
		...
		$this->load->view('designHardware/furnitureFittings/category', $data);
	}
