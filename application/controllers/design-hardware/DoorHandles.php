...
class DoorHandles extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_mixer_grinder = 13;
		$subcat_chopper = 13;
		$subcat_hand_blender = 13;
		$subcat_electric_kettle = 13;
		$subcat_sandwich_maker = 13;
		$subcat_rice_cooker = 13;
		...
		$this->load->view('designHardware/doorHandles/index', $data);
	}
	...
	public function category($slug)
	{
		...
		$doorhandleslug = "door-handles";
		$data['doorhandleslug'] = $doorhandleslug; 
		...
		$this->load->view('designHardware/doorHandles/category', $data);
	}
