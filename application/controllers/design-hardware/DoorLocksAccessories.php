...
class DoorLocksAccessories extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_mixer_grinder = 14;
		$subcat_chopper = 14;
		$subcat_hand_blender = 14;
		$subcat_electric_kettle = 14;
		$subcat_sandwich_maker = 14;
		$subcat_rice_cooker = 14;
		...
		$this->load->view('designHardware/DoorLocksAccessories/index', $data);
	}
	...
	public function category($slug)
	{
		...
		$doorLocksAccessoriesslug = "door-locks-and-accessories";
		$data['doorLocksAccessoriesslug'] = $doorLocksAccessoriesslug; 
		...
		$this->load->view('designHardware/doorLocksAccessories/category', $data);
	}
