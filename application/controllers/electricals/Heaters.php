...
class Heaters extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_instantheater = 7;
		$subcat_storageheater = 7;
		$subcat_immersionheater = 7;
		...
		$this->load->view('electricals/heaters/index', $data);
	}
	public function category($slug)
	{
		...
		$this->load->view('electricals/heaters/category', $data);
	}
