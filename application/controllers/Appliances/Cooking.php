...
class Cooking extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_mixer_grinder = 8;
		$subcat_chopper = 11;
		$subcat_hand_blender = 8;
		$subcat_electric_kettle = 8;
		$subcat_sandwich_maker = 8;
		$subcat_rice_cooker = 8;
		...
		$this->load->view('appliances/cooking/index', $data);
	}
	...
	public function category($slug)
	{
		...
		$this->load->view('appliances/cooking/category', $data);
	}
