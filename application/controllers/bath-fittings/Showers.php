...
class Showers extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('bathfittings/showers/index', $data);
	}
	...
	public function category($slug)
	{
		...
		$this->load->view('bathFittings/showers/category', $data);
	}
