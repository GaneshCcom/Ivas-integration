...
class Accessoriesandmirrors extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('bathfittings/accessoriesmirrors/index', $data);
	}
	public function category($slug)
	{
		...
		$par_id = 7;
		$catID = 19; 
		$accessoriesmirrorsslug = "accessoriesmirrors";
		$data['accessoriesmirrorsslug'] = $accessoriesmirrorsslug;
		...
		$this->load->view('bathfittings/accessoriesmirrors/category', $data);
	}
