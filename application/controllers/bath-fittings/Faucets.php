...
class Faucets extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_mixer_grinder = 21;
		$subcat_chopper = 21;
		$subcat_hand_blender = 21;
		$subcat_electric_kettle = 21;
		$subcat_sandwich_maker = 21;
		$subcat_rice_cooker = 21;
		...
		$this->load->view('bathfittings/faucets/index', $data);
	}	
	public function category($slug)
	{
		...
		$this->load->view('bathfittings/faucets/category', $data);
	}
