...
class BathFittings extends CI_Controller {
	...
	public function index()
	{
		...
		$reasonLists = $this->admin_model->get_all_reasons_byParId($parId)->result();
		$data['reasonLists'] = $reasonLists;
		...
		$cateLists = $this->admin_model->get_all_categories_byParId($parId);
		...
		$this->load->view('bathFittings/index', $data);
	}
