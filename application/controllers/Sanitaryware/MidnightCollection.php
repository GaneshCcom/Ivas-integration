...
class MidnightCollection extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_bldc = 16;
		$subcat_celling = 16;
		$subcat_ventilation = 16;
		$subcat_decorative = 16;
		...
		$this->load->view('sanitaryware/midnightCollection/index', $data);
	}
	...
	public function category($slug)
	{
		...
		$par_id = 5;
		$catID = 11;
		$midnightcollectionslug = "midnight-collection";
		$data['midnightcollectionslug'] = $midnightcollectionslug; 
		...
		$this->load->view('sanitaryware/midnightCollection/category', $data);
	}
