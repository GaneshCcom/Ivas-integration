...
class WaterClosets extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_bldc = 18;
		$subcat_celling = 18;
		$subcat_ventilation = 18;
		$subcat_decorative = 18;
		...
		$this->load->view('sanitaryware/waterClosets/index', $data);
	}
	public function category($slug)
	{
		...
		$par_id = 5;
		$catID = 12; 
		$waterclosetsslug = "water-closets";
		$data['waterclosetsslug'] = $waterclosetsslug;
		...
		$this->load->view('sanitaryware/waterclosets/category', $data);
	}
