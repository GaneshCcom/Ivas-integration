...
class WashBasins extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_bldc = 17;
		$subcat_celling = 17;
		$subcat_ventilation = 17;
		$subcat_decorative = 17;
		...
		$this->load->view('sanitaryware/washBasins/index', $data);
	}
	public function category($slug)
	{
		...
		$par_id = 5;
		$catID = 13; 
		$washbasinsslug = "wash-basins";
		$data['washbasinsslug'] = $washbasinsslug;
		...
		$this->load->view('sanitaryware/washBasins/category', $data);
	}
