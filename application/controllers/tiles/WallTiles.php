...
class WallTiles extends CI_Controller {
	...
	public function index()
	{
		...
		$subcat_bldc = 20;
		$subcat_celling = 20;
		$subcat_ventilation = 20;
		$subcat_decorative = 20;
		...
		$this->load->view('tiles/wallTiles/index', $data);
	}
	public function category($slug)
	{
		...
		$par_id = 6;
		$catID = 15; 
		$walltilesslug = "wall-tiles";
		$data['walltilesslug'] = $walltilesslug;
		...
		$this->load->view('tiles/walltiles/category', $data);
	}
